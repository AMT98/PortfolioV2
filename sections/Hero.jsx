              ...
              <div className="max-w-screen-xl mx-auto flex flex-col items-center justify-center h-full w-full px-4 md:flex-row">
                ...
                >
                  ...
                  <div className="rounded-xl flex gap-3 p-2 mt-4">
                    ...
                    <a href="https://www.linkedin.com/in/aswinmalla/" title="Linkedin" className="border hover:animate-pulse rounded-full border-transparent flex bg-indigo-500 p-2 m-1">
                  ...
                  <motion.img
                    ...
                    src="/arrow-down.svg"
                    alt="arrow down"
                    className="w-[18px] h-[28px] animate-bounce items-center self-center mt-[28px] hover:cursor-s-resize"
